...
const ReferPolicy = () => {
    return (
        <>
            ...
            <BreadCrumb title={'Home | PhysioZine'} link={'Home'} current={'Policy - Refer & Earn Policy'} />
            <section className={`${styles?.policy}`}>
                <div className={`${styles?.policyContent} container`}>
                    ...
                    <p className={`${styles.policyDetails} ${ubuntu?.className} mt-3`}>
                        We are excited to introduce our Refer & Earn program, designed to reward our valued contributors for spreading the word about PhysioZine
                    </p>

                    <h3 className={`${styles.subTitle} ${ubuntu?.className}`}>How it Works ?</h3>
                    <div className={`${styles?.line}`}></div>
                    <p className={`${styles.policyDetails} ${ubuntu?.className} mt-3`}>
                        <strong>Refer PhysioZine:</strong>
                        <br />
                        - Share the opportunity to publish articles with your network. Encourage professionals, researchers, and academicians in the field of physiotherapy to submit their work to PhysioZine.
                    </p>
                    ...
                    <p className={`${styles.policyDetails} ${ubuntu?.className} mt-3`}>
                        ...
                        - If their article is selected and published in the upcoming edition of PhysioZine, you will be eligible for one free publication in the next edition.
                    </p>
                    ...
                    <div className='mt-3'>
                        <ul>
                            ...
                            <li>
                                The referral must be a new contributor who has not published in PhysioZine before.
                            </li>
                            <li>
                            ...
                            <li>
                                The article must adhere to the publication guidelines and meet the editorial standards of PhysioZine.
                            </li>
                            <li>
                                This policy is subject to change at the discretion of the PhysioZine editorial team.
                            </li>
                            <li>
